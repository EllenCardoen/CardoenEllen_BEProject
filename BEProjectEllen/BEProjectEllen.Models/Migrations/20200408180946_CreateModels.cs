        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DifficultyId = table.Column<string>(nullable: true),
                    DifficultyId1 = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserChoices", x => new { x.UserQuizId, x.ChoiceId });
                    table.ForeignKey(
