...
namespace BEProjectEllen.Web.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class LoginModel : PageModel
    {
        ...
        private async Task AddTeacher()
        {
            ...
            if (await _signInManager.UserManager.FindByNameAsync(userName) == null)
            {
                ...
                if (result.Succeeded)
                {
                    await _signInManager.UserManager.AddPasswordAsync(user, userPassword);
                    await _signInManager.UserManager.AddToRoleAsync(user, adminRole);
                }
            }
        }
    }
